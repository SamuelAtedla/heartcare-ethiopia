        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
            <div className="bg-white rounded-3xl w-full max-w-lg overflow-hidden shadow-2xl animate-in fade-in zoom-in duration-300">
                <div className="bg-red-600 p-6 text-white text-center relative">
                    ...
                    <p className="opacity-80 text-sm font-medium">Select a doctor and available slot</p>
                </div>

                <div className="p-8 space-y-6 max-h-[70vh] overflow-y-auto custom-scrollbar">
                    {/* Doctor Selection */}
                    <div>
                        <label className="block text-xs font-bold text-gray-400 uppercase mb-2 tracking-wider">Select Specialist</label>
                            ...
                            {doctors.map(doc => (
                                ...
                                >
                                    ...
                                    <div>
                                        ...
                                        <div className="text-xs font-medium text-gray-500 uppercase tracking-tight">{doc.specialty || 'Cardiologist'}</div>
                                    </div>
                                </button>
                            ))}
                        </div>
                    ...
                    {/* Date Selection */}
                    <div>
                        <label className="block text-xs font-bold text-gray-400 uppercase mb-2 tracking-wider">Preferred Date</label>
                    ...
                    {selectedDate && (
                        <div>
                            <label className="block text-xs font-bold text-gray-400 uppercase mb-2 tracking-wider">Available Slots</label>
                    ...
                    {/* Communication Mode */}
                    <div>
                        <label className="block text-xs font-bold text-gray-400 uppercase mb-3 tracking-wider">Communication Preference</label>
                    ...
                    <div>
                        ...
                        <p className="text-[10px] text-gray-400 mt-1.5 ml-1">Make sure this number is active for {communicationMode}</p>
                    </div>

                    {/* Reason */}
                    <div>
                        <label className="block text-xs font-bold text-gray-400 uppercase mb-2 tracking-wider">Notes (Symptoms / History)</label>
                        <textarea
