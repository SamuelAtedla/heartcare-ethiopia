                            ...
                            {expandedArticle.attachment && (
                                <div className="mt-8 border-t border-gray-100 pt-8">
                                    <h4 className="text-sm font-bold text-gray-400 uppercase tracking-wider mb-4">
                                        {t('attachments', 'Supplementary Materials')}
                                    </h4>
                                    <a
                                        ...
                                        className="inline-flex items-center gap-3 bg-red-600 border border-red-600 px-6 py-3 rounded-2xl text-white font-bold hover:bg-white hover:text-red-600 transition-all shadow-lg shadow-red-100 group"
                                    >
                                        <div className="p-1.5 bg-white/20 rounded-lg group-hover:bg-red-600/10 transition">
